...
class MuleEmbedder:
    ...
    def predict(self, y, sr):
        ...
        # create source feature object from the raw audio array
        ...
        # create fresh MelSpectrogram transformer and apply it
        mel_transformer = MelSpectrogram(cfg=self.mel_cfg)
        mel_transformer.from_feature(waveform_feature)

        # reuse the pre-loaded EmbeddingFeature transformer
        self.embedding_transformer.from_feature(mel_transformer)

        # create fresh TimelineAverage transformer and apply it
